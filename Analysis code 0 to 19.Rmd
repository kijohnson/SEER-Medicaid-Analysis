...
# Open libraries
```{r}
pacman::p_load(readr, dplyr, tidyverse, lubridate, survival, survminer, hablar, table1, patchwork, xlsx)
```
...
library(gtsummary)
table3 <- list(
  survfit(Surv(survmo, can_dead) ~ In_Medicaid_Flag, data = seer0to19%>%filter(age_cat == "0-4")),
  survfit(Surv(survmo, can_dead) ~ In_Medicaid_Flag, data = seer0to19%>%filter(age_cat == "5-9")),
  survfit(Surv(survmo, can_dead) ~ In_Medicaid_Flag, data = seer0to19%>%filter(age_cat == "10-14")),
  survfit(Surv(survmo, can_dead) ~ In_Medicaid_Flag, data = seer0to19%>%filter(age_cat == "15-19"))
) %>%
  tbl_survfit(times = 60)

ST_MF_0to19 <- data.frame(table3$table_body)
...
table1[1:2,]<-c(st0to4$strata, st0to4$surv, st0to4$lower , st0to4$upper)
table1[3:4,]<-c(st5to9$strata, st5to9$surv, st5to9$lower , st5to9$upper)
table1[5:6,]<-c(st10to14$strata, st10to14$surv, st10to14$lower , st10to14$upper)
table1[7:8,]<-c(st15to19$strata, st15to19$surv, st15to19$lower , st15to19$upper)
...
table4 <- list(
  survfit(Surv(survmo, can_dead) ~ In_Medicaid_Flag, data = seer0to19%>%filter(race_ethnicity== "Non-Hispanic White")),
  survfit(Surv(survmo, can_dead) ~ In_Medicaid_Flag, data = seer0to19%>%filter(race_ethnicity=="Non-Hispanic Black")),
  survfit(Surv(survmo, can_dead) ~ In_Medicaid_Flag, data = seer0to19%>%filter(race_ethnicity == "Non-Hispanic AIAN")),
  survfit(Surv(survmo, can_dead) ~ In_Medicaid_Flag, data = seer0to19%>%filter(race_ethnicity == "Non-Hispanic API")),
  survfit(Surv(survmo, can_dead) ~ In_Medicaid_Flag, data = seer0to19%>%filter(race_ethnicity == "Hispanic")),
  survfit(Surv(survmo, can_dead) ~ In_Medicaid_Flag, data = seer0to19%>%filter(race_ethnicity == "Non-Hispanic Unknown"))
) %>%
  tbl_survfit(times = 60)

MF_race_0to19 <- data.frame(table4$table_body)
...
table4_category[2,] <- c("Non-Hispanic White","Medicaid not link")
table4_category[3,] <- c("Non-Hispanic White","Medicaid linked")
table4_category[5,] <- c("Non-Hispanic Black","Medicaid not link")
table4_category[6,] <- c("Non-Hispanic Black","Medicaid linked")
table4_category[8,] <- c("Non-Hispanic AIAN","Medicaid not link")
table4_category[9,] <- c("Non-Hispanic AIAN","Medicaid linked")
table4_category[11,] <- c("Non-Hispanic API","Medicaid not link")
table4_category[12,] <- c("Non-Hispanic API","Medicaid linked")
table4_category[14,] <- c("Hispanic","Medicaid not link")
table4_category[15,] <- c("Hispanic","Medicaid linked")
table4_category[17,] <- c("Non-Hispanic Unknown","Medicaid not link")
table4_category[18,] <- c("Non-Hispanic Unknown","Medicaid linked")

MF_race_0to19 <- cbind(MF_race_0to19, table4_category)
```
...
table5 <- A$data.survplot %>% 
  mutate(round_time = round(time,0)) %>%
           filter(round_time == 60)

table5 <- list(
  survfit(Surv(survmo, can_dead) ~ In_Medicaid_Flag, data = seer0to19%>%filter(can_type== "I. Leukemias, myeloproliferative diseases, and myelodysplastic diseases")),
  survfit(Surv(survmo, can_dead) ~ In_Medicaid_Flag, data = seer0to19%>%filter(can_type=="II. Lymphomas and reticuloendothelial neoplasms")),
  survfit(Surv(survmo, can_dead) ~ In_Medicaid_Flag, data = seer0to19%>%filter(can_type == "III. CNS and miscellaneous intracranial and intraspinal neoplasms")),
  survfit(Surv(survmo, can_dead) ~ In_Medicaid_Flag, data = seer0to19%>%filter(can_type == "IV. Neuroblastoma and other peripheral nervous cell tumors")),
  survfit(Surv(survmo, can_dead) ~ In_Medicaid_Flag, data = seer0to19%>%filter(can_type == "V. Retinoblastoma")),
  survfit(Surv(survmo, can_dead) ~ In_Medicaid_Flag, data = seer0to19%>%filter(can_type == "VI. Renal tumors")),
  survfit(Surv(survmo, can_dead) ~ In_Medicaid_Flag, data = seer0to19%>%filter(can_type == "VII. Hepatic tumors")),
  survfit(Surv(survmo, can_dead) ~ In_Medicaid_Flag, data = seer0to19%>%filter(can_type == "VIII. Malignant bone tumors")),
  survfit(Surv(survmo, can_dead) ~ In_Medicaid_Flag, data = seer0to19%>%filter(can_type == "IX. Soft tissue and other extraosseous sarcomas")),
  survfit(Surv(survmo, can_dead) ~ In_Medicaid_Flag, data = seer0to19%>%filter(can_type == "X. Germ cell tumors, trophoblastic tumors, and neoplasms of gonads")),
  survfit(Surv(survmo, can_dead) ~ In_Medicaid_Flag, data = seer0to19%>%filter(can_type == "XI. Other malignant epithelial neoplasms and malignant melanomas")),
  survfit(Surv(survmo, can_dead) ~ In_Medicaid_Flag, data = seer0to19%>%filter(can_type == "XII. Other and unspecified malignant neoplasms"))
) %>%
  tbl_survfit(times = 60)

MF_cancer_0to19 <- data.frame(table5$table_body)
...
table5_category[2,] <- c("I. Leukemias, myeloproliferative diseases, and myelodysplastic diseases","Medicaid not link")
table5_category[3,] <- c("I. Leukemias, myeloproliferative diseases, and myelodysplastic diseases","Medicaid linked")
table5_category[5,] <- c("II. Lymphomas and reticuloendothelial neoplasms","Medicaid not link")
table5_category[6,] <- c("II. Lymphomas and reticuloendothelial neoplasms","Medicaid linked")
table5_category[8,] <- c("III. CNS and miscellaneous intracranial and intraspinal neoplasms","Medicaid not link")
table5_category[9,] <- c("III. CNS and miscellaneous intracranial and intraspinal neoplasms","Medicaid linked")
table5_category[11,] <- c("IV. Neuroblastoma and other peripheral nervous cell tumors","Medicaid not link")
table5_category[12,] <- c("IV. Neuroblastoma and other peripheral nervous cell tumors","Medicaid linked")
table5_category[14,] <- c("V. Retinoblastoma","Medicaid not link")
table5_category[15,] <- c("V. Retinoblastoma","Medicaid linked")
table5_category[17,] <- c("VI. Renal tumors","Medicaid not link")
table5_category[18,] <- c("VI. Renal tumors","Medicaid linked")
table5_category[20,] <- c("VII. Hepatic tumors","Medicaid not link")
table5_category[21,] <- c("VII. Hepatic tumors","Medicaid linked")
table5_category[23,] <- c("VIII. Malignant bone tumors","Medicaid not link")
table5_category[24,] <- c("VIII. Malignant bone tumors","Medicaid linked")
table5_category[26,] <- c("IX. Soft tissue and other extraosseous sarcomas","Medicaid not link")
table5_category[27,] <- c("IX. Soft tissue and other extraosseous sarcomas","Medicaid linked")
table5_category[29,] <- c("X. Germ cell tumors, trophoblastic tumors, and neoplasms of gonads","Medicaid not link")
table5_category[30,] <- c("X. Germ cell tumors, trophoblastic tumors, and neoplasms of gonads","Medicaid linked")
table5_category[32,] <- c("XI. Other malignant epithelial neoplasms and malignant melanomas","Medicaid not link")
table5_category[33,] <- c("XI. Other malignant epithelial neoplasms and malignant melanomas","Medicaid linked")
table5_category[35,] <- c("XII. Other and unspecified malignant neoplasms","Medicaid not link")
table5_category[36,] <- c("XII. Other and unspecified malignant neoplasms","Medicaid linked")

MF_cancer_0to19 <- cbind(MF_cancer_0to19, table5_category)
...
```{r}
write.xlsx(Table2, file="SEER0to19analysis_tables.xlsx", sheetName = "Table 2. Cox PH 0 to 19", showNA=TRUE, append = FALSE)
```
...
# Export tables to excel
```{r}
write.xlsx(Table3, file="SEER0to19analysis_tables.xlsx", sheetName = "Table 3. Cox PH by age group", showNA=TRUE, append = FALSE)
```
...
# Export tables to excel
```{r}
write.xlsx(Table4, file="SEER0to19analysis_tables.xlsx", sheetName = "Table 4. Cox PH by race ethnicity", showNA=TRUE, append = FALSE)
```
...
```{r}
# model with interaction term between race category and medicaid flag
res.cox2_em <- coxph(Surv(survmo, can_dead) ~ In_Medicaid_Flag +race_cat +age_cat + Census_Tract_Poverty_Indicator + race_cat*In_Medicaid_Flag, data = seer0to19) # Model adjusted for race age and a measure of poverty
summary(res.cox2_em)

# likelihood ratio test
library(lmtest)
lrtest(res.cox2, res.cox2_em)

# model with interaction term between race cateogry and mcont3
res.cox4_em <- coxph(Surv(survmo, can_dead) ~ mcont3 + race_cat +age_cat + Census_Tract_Poverty_Indicator + race_cat*mcont3, data = seer0to19) # Model adjusted for race age and a measure of poverty
summary(res.cox4_em)

#likelihood ratio test
lrtest(res.cox4, res.cox4_em)
```

# Effect Modification by age category
```{r}
# model with interaction term between age category and medicaid flag
res.cox2_em2 <- coxph(Surv(survmo, can_dead) ~ In_Medicaid_Flag +race_cat +age_cat + Census_Tract_Poverty_Indicator + age_cat*In_Medicaid_Flag, data = seer0to19) # Model adjusted for race age and a measure of poverty
res.cox2_em2
summary(res.cox2_em2)

# likelihood ratio test
library(lmtest)
lrtest(res.cox2, res.cox2_em2)

# model with interaction term between age cateogry and mcont3
res.cox4_em2 <- coxph(Surv(survmo, can_dead) ~ mcont3 + race_cat +age_cat + Census_Tract_Poverty_Indicator + age_cat*mcont3, data = seer0to19) # Model adjusted for race age and a measure of poverty
summary(res.cox4_em2)

#likelihood ratio test
lrtest(res.cox4, res.cox4_em2)
```

# Effect Modification by tumor type
```{r}
# model without interaction term between tumor type and medicaid flag
res.cox5 <- coxph(Surv(survmo, can_dead) ~ In_Medicaid_Flag +race_cat +age_cat + Census_Tract_Poverty_Indicator + can_type, data = seer0to19) # Model adjusted for race age and a measure of poverty
res.cox5
summary(res.cox5)

# model with interaction term between tumor type and medicaid flag
res.cox5_em <- coxph(Surv(survmo, can_dead) ~ In_Medicaid_Flag +race_cat +age_cat + Census_Tract_Poverty_Indicator + can_type + can_type*In_Medicaid_Flag, data = seer0to19) # Model adjusted for race age and a measure of poverty
res.cox5_em
summary(res.cox5_em)

# likelihood ratio test
library(lmtest)
lrtest(res.cox5, res.cox5_em)

# model without interaction term between tumor type and medicaid enrollment flag
res.cox6 <- coxph(Surv(survmo, can_dead) ~ mcont3 +race_cat +age_cat + Census_Tract_Poverty_Indicator + can_type, data = seer0to19) # Model adjusted for race age and a measure of poverty
res.cox6
summary(res.cox6)

# model with interaction term between tumor type and medicaid flag
res.cox6_em <- coxph(Surv(survmo, can_dead) ~ mcont3 +race_cat +age_cat + Census_Tract_Poverty_Indicator + can_type + can_type*mcont3, data = seer0to19) # Model adjusted for race age and a measure of poverty
res.cox6_em
summary(res.cox6_em)

# likelihood ratio test
library(lmtest)
lrtest(res.cox6, res.cox6_em)
```

### Stratified models by age category
```{r}
age_strat <- function(age_f, outcome_var, model_outcome){
  seer0to19$outcome_var <<- outcome_var
  x <- seer0to19 %>%
      filter(age_cat == age_f)
model<-coxph(Surv(survmo, can_dead) ~ outcome_var +race_cat +age_cat + Census_Tract_Poverty_Indicator, data = x)
model_coef <- summary(model)

r <- data.frame(model_coef$coefficients)

# calculating odds ratio
r$HR <- round(exp(r$coef),2)
# calculating confidence intervals
r$lower95 <- round(exp(r$coef - 1.96*r$se.coef.),2)
r$upper95 <- round(exp(r$coef + 1.96*r$se.coef.),2)

r <- r%>%rownames_to_column() %>%
  mutate(model_outcome = model_outcome) %>%
  mutate(Age_Group = age_f)
r<-r[,c(1,7:11)]

}

A_flag <- age_strat("0-4", seer0to19$In_Medicaid_Flag, "In_Medicaid_Flag")
B_flag <- age_strat("5-9", seer0to19$In_Medicaid_Flag, "In_Medicaid_Flag")
C_flag <- age_strat("10-14", seer0to19$In_Medicaid_Flag,"In_Medicaid_Flag")
D_flag <- age_strat("15-19", seer0to19$In_Medicaid_Flag,"In_Medicaid_Flag")

A_dur <- age_strat("0-4", seer0to19$mcont3, "Enrollment duration")
B_dur <- age_strat("5-9", seer0to19$mcont3, "Enrollment duration")
C_dur <- age_strat("10-14", seer0to19$mcont3, "Enrollment duration")
D_dur <- age_strat("15-19", seer0to19$mcont3, "Enrollment duration")

age_table <- rbind(A_flag[c(1),],B_flag[c(1),],C_flag[c(1),],D_flag[c(1),],A_dur[c(1:3),],B_dur[c(1:3),],C_dur[c(1:3),],D_dur[c(1:3),])
...
```{r}
library(openxlsx)
write.xlsx(age_table, file="age_stratified_tables.xlsx", showNA=TRUE, overwrite=TRUE)

```

### Stratified models by tumor type
```{r}
cancer_strat <- function(tumor_type, outcome_var, model_outcome){
  seer0to19$outcome_var <<- outcome_var
  x <- seer0to19 %>%
      filter(can_type == tumor_type)
model<-coxph(Surv(survmo, can_dead) ~ outcome_var +race_cat +age_cat + Census_Tract_Poverty_Indicator, data = x)
model_coef <- summary(model)
...
r <- r%>%rownames_to_column() %>%
  mutate(model_outcome = model_outcome) %>%
  mutate(Cancer_type = tumor_type)
r<-r[,c(1,7:11)]

}

A_flag <- cancer_strat("I. Leukemias, myeloproliferative diseases, and myelodysplastic diseases", seer0to19$In_Medicaid_Flag, "In_Medicaid_Flag")
B_flag <- cancer_strat("II. Lymphomas and reticuloendothelial neoplasms", seer0to19$In_Medicaid_Flag, "In_Medicaid_Flag")
C_flag <- cancer_strat("III. CNS and miscellaneous intracranial and intraspinal neoplasms", seer0to19$In_Medicaid_Flag,"In_Medicaid_Flag")
D_flag <- cancer_strat("IV. Neuroblastoma and other peripheral nervous cell tumors", seer0to19$In_Medicaid_Flag,"In_Medicaid_Flag")
E_flag <- cancer_strat("V. Retinoblastoma", seer0to19$In_Medicaid_Flag,"In_Medicaid_Flag")
F_flag <- cancer_strat("VI. Renal tumors", seer0to19$In_Medicaid_Flag,"In_Medicaid_Flag")
G_flag <- cancer_strat("VII. Hepatic tumors", seer0to19$In_Medicaid_Flag,"In_Medicaid_Flag")
H_flag <- cancer_strat("VIII. Malignant bone tumors", seer0to19$In_Medicaid_Flag,"In_Medicaid_Flag")
I_flag <- cancer_strat("IX. Soft tissue and other extraosseous sarcomas", seer0to19$In_Medicaid_Flag,"In_Medicaid_Flag")
J_flag <- cancer_strat("X. Germ cell tumors, trophoblastic tumors, and neoplasms of gonads", seer0to19$In_Medicaid_Flag,"In_Medicaid_Flag")
K_flag <- cancer_strat("XI. Other malignant epithelial neoplasms and malignant melanomas", seer0to19$In_Medicaid_Flag,"In_Medicaid_Flag")
L_flag <- cancer_strat("XII. Other and unspecified malignant neoplasms", seer0to19$In_Medicaid_Flag,"In_Medicaid_Flag")

type_table <- rbind(A_flag[c(1),],B_flag[c(1),],C_flag[c(1),],D_flag[c(1),],E_flag[c(1),],F_flag[c(1),],G_flag[c(1),],H_flag[c(1),],I_flag[c(1),],J_flag[c(1),],K_flag[c(1),],L_flag[c(1),])
...
```{r}
library(openxlsx)
write.xlsx(type_table, file="type_stratified_tables.xlsx", showNA=TRUE, overwrite=TRUE)
